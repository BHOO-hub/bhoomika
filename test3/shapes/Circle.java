...
// Class Circle
public class Circle {
    // Problem Statement 3a: Restrict access to the variable radius
    private float radius;

    // Problem Statement 3b: Package level access to Constructor 2 and variable pi
    float pi;
    ...
    // Problem Statement 4a: Method to calculate area
    float calculateCircleArea(float radius) {
        return pi * radius * radius;
    }

    // Problem Statement 4b: Method to calculate circumference
